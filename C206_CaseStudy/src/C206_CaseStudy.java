...
public class C206_CaseStudy {
	...
	public static void main(String[] args) {
		...
		ArrayList<Parent> parentListTest = new ArrayList<Parent>();
		parentListTest.add(new Parent("123456", "Peter", "C206", "Armstong", "David", "123456@myrp.edu.sg", 99999999));
		
		C206_CaseStudy.viewAllParent(parentListTest);
		
//		C206_CaseStudy.deleteAllParent(parentListTest);
